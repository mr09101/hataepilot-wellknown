...
최신 작업(2026-09-21)은 [수동 진단 전송·조회](updates/진단-전송과-조회-운영안내.md)와 `HANDOFF.md` 맨 위 기록을 따릅니다. 진단 Worker 배포·HTTP 검증, OTA 정상0.5.9/code30·복구31 게시, 실제 폰code30 데이터 유지 설치·수동167이벤트 전송·관리자 재조회는 **구현·검증 완료**입니다. 실제 차량 하차·무선 설치/복구는 **구현됐으나 검증 필요**입니다. 아래 예전 날짜의 증거는 당시 이력입니다.
